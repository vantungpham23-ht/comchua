...
<div class="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50 pb-16 overflow-x-hidden">
	...
	<!-- Footer -->
	<footer class="text-center mt-12 px-6 py-6">
		<p class="text-gray-500 text-sm flex items-center justify-center gap-2">
			Thiết kế bởi <span class="font-bold text-orange-600">Aiden Phạm</span>
		</p>
		<a 
			href="https://www.instagram.com/vt.phh/" 
			target="_blank" 
			rel="noopener noreferrer"
			class="inline-flex items-center justify-center w-10 h-10 mt-3 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded-full text-white hover:scale-110 hover:shadow-lg transition-all duration-300"
		...
		<p class="text-gray-400 text-xs mt-3">Powered by Groq AI + Llama 3.3</p>
	</footer>
</div>
